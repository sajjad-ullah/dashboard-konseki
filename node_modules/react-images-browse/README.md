...
Simple component for browsing, uploading and validating (client side) images with preview built with React.js.
This package uses ['react-flip-move'](https://github.com/joshwcomeau/react-flip-move) for animating the preview image files. This is a modified version of 'react-images-upload' from [JakeHartnell/react-images-upload](https://github.com/JakeHartnell/react-images-upload).
